...
abstract class AdminUrl {
  ...
  static final tournamentCompleted = "${AppUrl.baseUrl}/tournament/completed";
  ...
  static final removeGroupFromTournament =
      "${AppUrl.baseUrl}/group/from/tournament";
}
...
abstract class UserUrl {
  ...
  static final viewNews = "${AppUrl.baseUrl}/superadmin/api/view-news";
